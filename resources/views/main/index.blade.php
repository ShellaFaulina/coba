                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="display-3 text-white animated slideInLeft">Selamat Datang<br>di Pesona Coffe!</h1>
                            <p class="text-white animated slideInLeft mb-4 pb-2"> Nikmati pengalaman kopi yang luar biasa dengan cita rasa unik dan berkualitas tinggi di setiap tegukan. Kami dengan bangga menyajikan berbagai pilihan kopi pilihan, diracik dengan teliti untuk memenuhi selera Anda.</p>
                            <a href="{{ url('/main/menu') }}" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Our Menu</a>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Quality Coffe</h5>
                                <p>Kualitas kopi adalah prioritas utama kami. Kami hanya menggunakan biji kopi terbaik dari sumber yang terpercaya, diracik dengan hati untuk menciptakan minuman kopi yang memikat lidah dan menyehatkan jiwa. </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 pb-3" data-bs-toggle="pill" href="#tab-2">
                                ...
                                <div class="ps-3">
                                    ...
                                    <h6 class="mt-n1 mb-0">Non-coffe</h6>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Americano</span>
                                                <span class="text-primary">16.000</span>
                                            </h5>
                                            <small class="fst-italic">jhdcsjbcbkj</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Coffe Milk</span>
                                                <span class="text-primary">21.000</span>
                                            </h5>
                                            <small class="fst-italic">Coffe Milk gfhh</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            ...
                                            <small class="fst-italic">hvmhjhjbhb</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            ...
                                            <small class="fst-italic">ghfghgv</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                ...
                                                <span class="text-primary">24.000</span>
                                            </h5>
                                            <small class="fst-italic">ada tiga pilihan untuk menu ini, yaitu caramel, hazelnut, vanilla</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Lemon Coffe</span>
                                                <span class="text-primary">18.000</span>
                                            </h5>
                                            <small class="fst-italic">fgyfghch</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Pandan Coffe</span>
                                                <span class="text-primary">21.000</span>
                                            </h5>
                                            <small class="fst-italic">hgkhgjjnb </small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Double Coffe Milk</span>
                                                <span class="text-primary">21.000</span>
                                            </h5>
                                            <small class="fst-italic">hghjhbnb</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item text-center rounded overflow-hidden">
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                <a class="btn btn-square btn-primary mx-1" href="https://www.facebook.com/login.php"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-primary mx-1" href="https://twitter.com/i/flow/login?redirect_after_login=%2Fsofwanam3"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square btn-primary mx-1" href="https://www.instagram.com/accounts/login/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                    </div>
